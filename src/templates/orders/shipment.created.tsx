...
interface ShipmentCreatedComponent {
  data: any;
}

const ShipmentCreatedComponent: React.FC<ShipmentCreatedComponent> = ({ data }) => {
  return (
    <Html>
      <Head />
      <Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            <Img
              src={`${data.store_url}/static/nike-logo.png`}
              width="66"
              height="22"
              alt="Nike"
              style={{ margin: "auto" }}
          ...
          >
            <Row>
              <Column>
                <Img
                  src={`${data.store_url}/static/nike-product.png`}
          ...
          <Section style={paddingY}>
            ...
            <Row style={recomendations.container}>
              ...
              >
                <Img
                  src={`${data.store_url}/static/nike-recomendation-1.png`}
                  alt="Brazil 2022/23 Stadium Away Women's Nike Dri-FIT Soccer Jersey"
                  width="100%"
                />
              ...
              <Column style={recomendations.product} align="center">
                <Img
                  src={`${data.store_url}/static/nike-recomendation-2.png`}
                  alt="Brazil 2022/23 Stadium Away Women's Nike Dri-FIT Soccer Jersey"
                  width="100%"
                />
                <Text style={recomendations.title}>
              ...
              <Column style={recomendations.product} align="center">
                <Img
                  src={`${data.store_url}/static/nike-recomendation-4.png`}
                  alt="Brazil 2022/23 Stadium Away Women's Nike Dri-FIT Soccer Jersey"
                  width="100%"
                />
              ...
              <Column>
                <Row>
                  <Column style={{ width: "16px" }}>
                    <Img
                      src={`${data.store_url}/static/nike-phone.png`}
                      width="16px"
                      height="26px"
...
export default function shipmentCreatedTemplate(data: any = {}) {
  return render(<ShipmentCreatedComponent data={data} />, {
    pretty: true,
  });
}
