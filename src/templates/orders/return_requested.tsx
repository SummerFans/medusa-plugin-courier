...
interface ReturnRequestedComponent {
  data: any;
}

const ReturnRequestedComponent: React.FC<ReturnRequestedComponent> = ({ data }) => {
  return (
    <Html>
      <Head />
      <Preview>
...
export default function placedTemplate(data: any = {}) {
  return render(<ReturnRequestedComponent data={data} />, {
    pretty: true,
  });
}
